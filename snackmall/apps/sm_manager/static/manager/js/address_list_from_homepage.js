var app =new Vue({
	...
	methods:{
		returnTo(){
			window.location.href = "/manager/user_home/";
		},
		...
		edit_self(index){			
			window.location.href="/manager/edit_address/"+ this.recv_infos[index].id +"//manager/address_list_from_homepage/"
		},
		
		add_address(){
			window.location.href="/manager/add_address//manager/address_list_from_homepage/";
		},
